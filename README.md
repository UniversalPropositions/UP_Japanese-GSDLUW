...
- `git clone https://github.com/UniversalPropositions/UP_Japanese-GSDLUW.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Japanese-GSDLUW>/ --input_up=<up_path_to_UP_Japanese-GSDLUW>/ --output=<path_to_UD+UP_Japanese-GSDLUW>/`
